...
GamesFrame.Position = UDim2.new(1, 15, 0, 0) 
GamesFrame.BackgroundColor3 = Color3.fromRGB(8, 6, 12)
...
GamesCorner.CornerRadius = UDim.new(0, 14)
GamesCorner.Parent = GamesFrame

local GamesStroke = Instance.new("UIStroke")
GamesStroke.Color = Color3.fromRGB(0, 0, 0)
GamesStroke.Thickness = 1.6
GamesStroke.Transparency = 1
GamesStroke.Parent = GamesFrame

local GamesGlowStroke = Instance.new("UIStroke")
GamesGlowStroke.Color = Color3.fromRGB(186, 86, 253)
GamesGlowStroke.Thickness = 1.8
GamesGlowStroke.Transparency = 1
GamesGlowStroke.Parent = GamesFrame

local GamesGlowGradient = Instance.new("UIGradient")
GamesGlowGradient.Transparency = NumberSequence.new({
    NumberSequenceKeypoint.new(0, 1),
    NumberSequenceKeypoint.new(0.15, 0),
    NumberSequenceKeypoint.new(0.35, 1),
    NumberSequenceKeypoint.new(0.65, 1),
...
GamesGlowGradient.Parent = GamesGlowStroke
table.insert(activeNotifGradients, GamesGlowGradient) 

local GamesHeader = Instance.new("TextLabel")
GamesHeader.Size = UDim2.new(1, 0, 0, 30)
GamesHeader.Position = UDim2.new(0, 0, 0, 8)
GamesHeader.BackgroundTransparency = 1
GamesHeader.Text = "Games We Support"
GamesHeader.TextColor3 = Color3.fromRGB(168, 85, 247)
GamesHeader.TextSize = 13
GamesHeader.Font = Enum.Font.GothamBold
GamesHeader.TextTransparency = 1
...
GamesScroll.ScrollBarImageColor3 = Color3.fromRGB(168, 85, 247)
...
JoinPopup.AnchorPoint = Vector2.new(0.5, 0.5)
JoinPopup.Position = UDim2.new(0.5, 0, 0.5, 0)
JoinPopup.BackgroundColor3 = Color3.fromRGB(12, 9, 18)
JoinPopup.BackgroundTransparency = 0.05
JoinPopup.Visible = false
JoinPopup.ZIndex = 50
JoinPopup.Parent = ScreenGui 

local PopupCorner = Instance.new("UICorner")
PopupCorner.CornerRadius = UDim.new(0, 12)
PopupCorner.Parent = JoinPopup

local PopupStroke = Instance.new("UIStroke")
PopupStroke.Color = Color3.fromRGB(186, 86, 253)
PopupStroke.Thickness = 1.5
PopupStroke.Parent = JoinPopup

local PopupText = Instance.new("TextLabel")
PopupText.Size = UDim2.new(1, -20, 0, 60)
PopupText.Position = UDim2.new(0, 10, 0, 15)
PopupText.BackgroundTransparency = 1
PopupText.Text = ""
PopupText.TextColor3 = Color3.fromRGB(243, 232, 255)
PopupText.TextSize = 14
PopupText.Font = Enum.Font.GothamBold
PopupText.TextWrapped = true
PopupText.Parent = JoinPopup

local YesBtn = Instance.new("TextButton")
YesBtn.Size = UDim2.new(0.5, -20, 0, 35)
YesBtn.Position = UDim2.new(0, 15, 1, -50)
YesBtn.BackgroundColor3 = Color3.fromRGB(20, 14, 30)
YesBtn.Text = "Yes"
YesBtn.TextColor3 = Color3.fromRGB(74, 222, 128)
YesBtn.Font = Enum.Font.GothamBold
YesBtn.AutoButtonColor = false
YesBtn.Parent = JoinPopup
...
YesStroke.Color = Color3.fromRGB(60, 40, 90)
YesStroke.Parent = YesBtn

local NoBtn = Instance.new("TextButton")
NoBtn.Size = UDim2.new(0.5, -20, 0, 35)
NoBtn.Position = UDim2.new(0.5, 5, 1, -50)
NoBtn.BackgroundColor3 = Color3.fromRGB(20, 14, 30)
NoBtn.Text = "No"
NoBtn.TextColor3 = Color3.fromRGB(248, 113, 113)
NoBtn.Font = Enum.Font.GothamBold
NoBtn.AutoButtonColor = false
NoBtn.Parent = JoinPopup
...
NoStroke.Color = Color3.fromRGB(60, 40, 90)
NoStroke.Parent = NoBtn

local selectedPlaceId = 0

YesBtn.MouseButton1Click:Connect(function()
    playSound(135244211779631)
    if selectedPlaceId ~= 0 then
        JoinPopup.Visible = false
...
NoBtn.MouseButton1Click:Connect(function()
    playSound(106351605533621)
    TweenService:Create(JoinPopup, TweenInfo.new(0.2, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {Size = UDim2.new(0, 200, 0, 90)}):Play()
    task.wait(0.2)
    JoinPopup.Visible = false
end)

YesBtn.MouseEnter:Connect(function() TweenService:Create(YesStroke, TweenInfo.new(0.2), {Color = Color3.fromRGB(74, 222, 128)}):Play() end)
YesBtn.MouseLeave:Connect(function() TweenService:Create(YesStroke, TweenInfo.new(0.2), {Color = Color3.fromRGB(60, 40, 90)}):Play() end)
...
local function addSupportedGame(gameName, gameDesc, placeId, customPanelIconId)
    ...
    if customPanelIconId and customPanelIconId ~= "" and customPanelIconId ~= 0 then
        card.Image = "rbxassetid://" .. tostring(customPanelIconId)
    else
        card.Image = "rbxthumb://type=GameIcon&id=" .. tostring(placeId) .. "&w=150&h=150"
    end
    ...
    cardStroke.Color = Color3.fromRGB(60, 40, 90)
    ...
    clickLabel.Size = UDim2.new(1, -15, 0, 15)
    ...
    card.MouseLeave:Connect(function()
        TweenService:Create(cardStroke, TweenInfo.new(0.2), {Color = Color3.fromRGB(60, 40, 90)}):Play()
        TweenService:Create(overlay, TweenInfo.new(0.2), {BackgroundTransparency = 0.75}):Play()
    end)
    
    card.MouseButton1Click:Connect(function()
        playSound(106351605533621)
        selectedPlaceId = placeId
        PopupText.Text = 'Do you wanna join the game\n"' .. gameName .. '"?'
        JoinPopup.Size = UDim2.new(0, 250, 0, 90)
        JoinPopup.Visible = true
        TweenService:Create(JoinPopup, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Size = UDim2.new(0, 300, 0, 140)}):Play()
    end)
end
...
task.spawn(function()
    ...
    TweenService:Create(GamesFrame, TweenInfo.new(0.45, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
        BackgroundTransparency = 0.45
    }):Play()
    TweenService:Create(GamesStroke, TweenInfo.new(0.45), {Transparency = 0}):Play()
    TweenService:Create(GamesGlowStroke, TweenInfo.new(0.45), {Transparency = 0}):Play()
    TweenService:Create(GamesHeader, TweenInfo.new(0.45), {TextTransparency = 0}):Play()
...
local function closeGUI()
    ...
    TweenService:Create(GamesFrame, TweenInfo.new(0.35), {BackgroundTransparency = 1}):Play()
    TweenService:Create(GamesStroke, TweenInfo.new(0.35), {Transparency = 1}):Play()
    TweenService:Create(GamesGlowStroke, TweenInfo.new(0.35), {Transparency = 1}):Play()
...
local function minimizeGUI()
    ...
    TweenService:Create(GamesFrame, TweenInfo.new(0.3), {BackgroundTransparency = 1}):Play()
    TweenService:Create(GamesStroke, TweenInfo.new(0.3), {Transparency = 1}):Play()
    TweenService:Create(GamesGlowStroke, TweenInfo.new(0.3), {Transparency = 1}):Play()
...
local function restoreGUI()
    ...
    TweenService:Create(GamesFrame, TweenInfo.new(0.4, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
        BackgroundTransparency = 0.45
    }):Play()
    TweenService:Create(GamesStroke, TweenInfo.new(0.4), {Transparency = 0}):Play()
    TweenService:Create(GamesGlowStroke, TweenInfo.new(0.4), {Transparency = 0}):Play()
...
local function createScriptCard(titleText, descText, yPos, imageUrl, callback)
